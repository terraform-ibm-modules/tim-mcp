...
required_dependencies = [
  {
    source_module = "resource_group"
    source_output = "resource_group_id"
    target_input  = "resource_group_id"
  },
  {
    source_module = "kms"
    source_output = "key_id"
    target_input  = "kms_key_crn"
  }
]
...
optional_dependencies = [
  {
    source_module = "cos"
    source_output = "bucket_name"
    target_input  = "backup_bucket"
  }
]
```
